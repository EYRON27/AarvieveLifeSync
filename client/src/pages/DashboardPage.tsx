...
export default function DashboardPage() {
  ...
  useEffect(() => {
    // Show terms if dbUser exists and hasn't accepted dashboard terms yet
    if (dbUser && dbUser.preferences?.hasAcceptedDashboardTerms !== true) {
      setShowTerms(true);
    }
  }, [dbUser]);

  const handleAcceptTerms = async () => {
    if (!agreeToTerms || !dbUser) return;
    setIsUpdating(true);
    try {
      const res = await authApi.updateProfile({
        preferences: { ...dbUser.preferences, hasAcceptedDashboardTerms: true }
      });
          ...
          >
            ...
            >
              <div className="p-6 border-b border-white/10">
                <h3 className="text-2xl font-bold text-white tracking-tight">Welcome to LifeSync! 🎉</h3>
              ...
              <div className="p-6 border-t border-white/10 bg-black/20 shrink-0">
                ...
                <button 
                  ...
                  disabled={!agreeToTerms || isUpdating}
